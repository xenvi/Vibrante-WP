    ...
    <section class="landing">
        ...
        <div class="landing-wrapper container">
            ...
            <div class="blob-wrapper">
                ...
                <svg class="imageblob" width="300px" height="350px" viewBox="0 20 200 200" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <clipPath id="shape">
                    ...
                    <image width="275px" height="200px" clip-path="url(#shape)" xlink:href="<?php the_post_thumbnail_url('blog-small');?>" />
                </svg>
             </div>
        </div>
